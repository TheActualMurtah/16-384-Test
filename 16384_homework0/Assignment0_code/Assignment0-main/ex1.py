...
def main():
    ...
    A = np.array([[1, 2], [3, 4]])  # Populate with appropriate values
    B = np.array([[1,2,3], [4,5,6]])  # Populate with appropriate values
    ...
    vector = [10, 20]  # Populate with appropriate values
